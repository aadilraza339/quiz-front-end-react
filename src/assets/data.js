const qBank = [
    ...
    },
    {
        id: 0,
        question: `Guess the name of animal`,
        options: [`Deer`, `Camel`, `Zebra`, `Cow`],
        Images: [`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYScavPpr6-thVP8BeFtVQZ754UNmZT7jvaA&usqp=CAU`],
        correctAnswer: `Zebra`
    },
    {
        id: 0,
        question: `Guess the name of animal`,
        options: [`Cat`, `Camel`, `Zebra`, `Cow`],
        Images: [`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNSNa4eQ2iIAOPEMCPxdUodWn5s_AOp_A80g&usqp=CAU`],
        correctAnswer: `Cat`
    },
    {
        id: 0,
        question: `Guess the name of animal`,
        options: [`Cat`, `Peacoock`, `Zebra`, `Cow`],
        Images: [`https://resources.stuff.co.nz/content/dam/images/4/y/q/y/k/n/image.related.StuffLandscapeSixteenByNine.710x400.21tj4y.png/1613201879374.jpg?format=pjpg&optimize=medium`],
        correctAnswer: `Peacoock`
    },
]
